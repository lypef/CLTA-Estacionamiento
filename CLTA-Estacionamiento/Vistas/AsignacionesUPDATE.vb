Public Class AsignacionesUPDATE
    ...
    Public Sub loadvalues()
        ...
        f.Vehicle_LoadValuesAsignacion(ImagenPropietario, ComboBoxTarifas, LabelCliente, LabelVehiculo, RB_Hora, RB_Dias, Rb_Pension, LabelMatricula)
        LoadTotal()
        c_event = True
